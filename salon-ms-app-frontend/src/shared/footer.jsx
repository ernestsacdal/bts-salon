...
const Footer = () => {
  return (
    <div className='bg-[#010851] md:px-4 p-4 max-w-screen-2xl mx-auto text-white'>
        <div className='my-12 flex flex-col md:flex-row gap-10'>
            <div className='md:w-1/2 space-y-8'>
                <a href='/' className='text-2xl font-semibold flex items-center space-x-3 text-primary'>
                <img src={logo} alt='' className='w-10 inline-block items-center'/><span className='text-white'>BTS</span>
                </a>
                ...
                <div>
                    <input type="email" name="email" id="email" placeholder='email' className='bg-[#9a7af159] py-2 px-4 rounded-md focus:outline-none'/>
                    <input type='submit' value='Subscribe' className='px-4 py-2 bg-second rounded-md -ml-2 cursor-pointer hover:bg-white hover:text-primary duration-300 transition-all'/>
                </div>
            </div>
        ...
        <div className='flex flex-col sm:flex-row gap-8 sm:items-center justify-between my-8'>
            ...
            <div className='flex items-center space-x-5'>
                ...
                <img src={LinkIn} alt='' className='w-8 cursor-pointer hover:translate-y-4 transition-all duration-300' />
